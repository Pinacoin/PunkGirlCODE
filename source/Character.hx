...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-punk':
				tex = Paths.getSparrowAtlas('rockconcert/hot_topic_gf');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'bf-punk':
				var tex = Paths.getSparrowAtlas('rockconcert/hot_topic_bf');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'punk':
				tex = Paths.getSparrowAtlas('rockconcert/PunkASSETS');
				frames = tex;
				animation.addByPrefix('idle', 'punkIdle', 24);
				animation.addByPrefix('singUP', 'punkUp', 24);
				animation.addByPrefix('singRIGHT', 'punkRight', 24);
				animation.addByPrefix('singDOWN', 'punkDown', 24);
				animation.addByPrefix('singLEFT', 'punkLeft', 24);
